...
<div style="position:absolute;left:200.59px;top:193.60px" class="cls_014">
	<span class="cls_014">{{ $GeneralHelper->splitSpace($shoppingcart->shoppingcart_payment->va_number,4) }}</span>
</div>
...
<div style="position:absolute;left:393.01px;top:694.52px" class="cls_007"><span class="cls_007">Masukkan 16 digit</span></div>
...
<div style="position:absolute;left:392.85px;top:1288.95px" class="cls_010"><span class="cls_010">{{$shoppingcart->shoppingcart_payment->bank_code}}{{ $shoppingcart->shoppingcart_payment->va_number }}</span>
</div>
...
<div style="position:absolute;left:392.99px;top:1378.29px" class="cls_007"><span class="cls_007">16 digit Nomor Rekening, lalu</span></div>
...
<div style="position:absolute;left:394.00px;top:2370.00px" class="cls_007"><span class="cls_007">Masukkan 16 digit Nomor</span></div>
