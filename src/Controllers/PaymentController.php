...
class PaymentController extends Controller
{
    ...
    public function paypal_jscript($sessionId)
    {
        ...
        jQuery(document).ready(function($) {
            ...
            $("#submitCheckout").slideUp("slow");  
            $("#paymentContainer").html(\'<div id="proses"><div id="paypal-button-container"></div><div id="change_payment" class="mt-2"><center><small>Refresh this page to change payment method</small></center></div></div><div id=\"loader\" class=\"mb-4\"></div><div id=\"text-alert\" class=\"text-center\"></div>\');
