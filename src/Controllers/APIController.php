...
class APIController extends Controller
{
    ...
    public function instruction($sessionId,$id)
    {
        ...
        $pdf = PDF::setOptions(['tempDir' => 'gs://budisteikul.appspot.com/tempDir/','isRemoteEnabled' => true])->loadView('toursdk::layouts.manual.bank_transfer', compact('shoppingcart'))->setPaper($customPaper,'portrait');
    ...
    public function invoice($sessionId,$id)
    {
        ...
        $pdf = PDF::setOptions(['tempDir' => 'gs://budisteikul.appspot.com/tempDir/','isRemoteEnabled' => true])->loadView('toursdk::layouts.pdf.invoice', compact('shoppingcart','qrcode'))->setPaper('a4', 'portrait');
    ...
    public function ticket($sessionId,$id)
    {
        ...
        $pdf = PDF::setOptions(['tempDir' => 'gs://budisteikul.appspot.com/tempDir/','isRemoteEnabled' => true])->loadView('toursdk::layouts.pdf.ticket', compact('shoppingcart_product','qrcode'))->setPaper($customPaper);
